...
public class FloatSampleTools {
	 ...
	 * a byte array to a normalized float array. In order to accommodate
	...
	static void byte2floatGeneric(byte[] input, int inByteOffset, int inByteStep,
	                              float[] output, int outOffset, int sampleCount,
	                              int formatType) {
Debug.println("FloatSampleTools.byte2floatGeneric, formatType=" + formatType2Str(formatType));
	 ...
	 * a byte array. In order to accommodate interleaved and non-interleaved
