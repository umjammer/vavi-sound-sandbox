 ...
 * version which allows explicitly to disable lazy deletion.
 * <p>
 ...
 * dithering can be explicitly switched on or off with
...
public class FloatSampleBuffer {
    ...
    private ArrayList<float[]> channels = new ArrayList<>(); // contains for each channel a float array
