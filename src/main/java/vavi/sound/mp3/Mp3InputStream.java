...
/**
 * Mp3InputStream.
 * <li> TODO ç°ÇÃÇ∆Ç±ÇÎ {@link #read()} ÇégópÇµÇƒÇÕÇ¢ÇØÇ‹ÇπÇÒÅB
 * 
 * @author è¨êô ìƒéj (Kosugi Atsushi)
...
public class Mp3InputStream extends FilterInputStream {
    ...
    public Mp3InputStream(InputStream in) throws IOException {
        ...
        // read temporary
        byte[] buf = new byte[4096]; // TODO 4096 byte Ç‹Ç≈Ç… firstSync Ç™Ç†ÇÈÇ∆âºíËÇµÇƒÇ¢ÇÈ 
        int readBytes = 0;
