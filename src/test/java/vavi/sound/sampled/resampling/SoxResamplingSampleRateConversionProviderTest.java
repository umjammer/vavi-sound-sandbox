...
/**
 * SoxResamplingSampleRateConversionProviderTest.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-07-09 nsano initial version <br>
 */
public class SoxResamplingSampleRateConversionProviderTest {
    ...
    static void setup() throws IOException {
        ...
        System.setProperty("vavi.sound.sampled.spi.sox_resmpling", "true");
    }

    @AfterAll
    static void tearDown() throws IOException {
        System.setProperty("vavi.sound.sampled.spi.sox_resmpling", "false");
    }
...
Debug.println(is.getClass().getName());
        assertInstanceOf(ResamplerInputStream.class, is);
