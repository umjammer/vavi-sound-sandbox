...
import vavi.sound.pcm.resampling.sox.PolyphaseTest;
...
/**
 * SoxPolyphaseSampleRateConversionProviderTest.
 * <p>
 * jdk has {@link com.sun.media.sound.AudioFloatFormatConverter} !!
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-07-09 nsano initial version <br>
 */
public class SoxPolyphaseSampleRateConversionProviderTest {
    ...
    static void setup() throws IOException {
        ...
        System.setProperty("vavi.sound.sampled.spi.sox_polyphase", "true");
    }

    @AfterAll
    static void tearDown() throws IOException {
        System.setProperty("vavi.sound.sampled.spi.sox_polyphase", "false");
    }
...
Debug.println(is.getClass().getName());
        assertInstanceOf(PolyphaseInputStream.class, is);
