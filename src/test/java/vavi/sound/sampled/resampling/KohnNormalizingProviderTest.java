...
/**
 * LaoeSampleRateConversionProviderTest.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-07-09 nsano initial version <br>
 */
@Disabled("wip")
public class KohnNormalizingProviderTest {
    ...
    static void setup() throws IOException {
        ...
        System.setProperty("vavi.sound.sampled.spi.kohn", "true");
    }

    @AfterAll
    static void tearDown() throws IOException {
        System.setProperty("vavi.sound.sampled.spi.kohn", "false");
    }
...
//        assertInstanceOf(LaoeInputStream.class, is); // TODO no specific classes?
