...
/**
 * RohmSampleRateConversionProviderTest.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-07-09 nsano initial version <br>
 */
public class RohmSampleRateConversionProviderTest {
    ...
    static void setup() throws IOException {
        ...
        System.setProperty("vavi.sound.sampled.spi.rohm", "true");
    }

    @AfterAll
    static void tearDown() throws IOException {
        System.setProperty("vavi.sound.sampled.spi.rohm", "false");
    }
...
Debug.println(is.getClass().getName());
        assertInstanceOf(RohmInputStream.class, is);
