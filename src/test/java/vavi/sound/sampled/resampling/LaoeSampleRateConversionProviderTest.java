 ...
 */
public class LaoeSampleRateConversionProviderTest {
    ...
    static void setup() throws IOException {
        ...
        System.setProperty("vavi.sound.sampled.spi.laoe", "true");
    }

    @AfterAll
    static void tearDown() throws IOException {
        System.setProperty("vavi.sound.sampled.spi.laoe", "false");
    }
...
Debug.println(is.getClass().getName());
        assertInstanceOf(LaoeInputStream.class, is);
