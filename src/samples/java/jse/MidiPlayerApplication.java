...
public class MidiPlayerApplication extends JFrame {
    ...
    private static final Logger logger = getLogger(MidiPlayerApplication.class.getName());

    private final JButton m_loadButton;
    private final JLabel m_sequenceLabel;
    private JFileChooser m_fileChooser;
    private final MidiPlayerPanel m_midiPlayerPanel;
    ...
    public MidiPlayerApplication() {
        ...
        m_loadButton.addActionListener(ae -> loadSequence());
