    ...
    public static void main(String[] args) {
        ...
        if (line == null) {
            ...
            AudioFormat targetFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED,
                                                       ...
                                                       false);
            if (DEBUG) {
                System.out.println("AudioPlayer.<init>(): source format: " +
                                   sourceFormat);
                System.out.println("AudioPlayer.<init>(): target format: " +
                                   targetFormat);
            }
            ...
            if (DEBUG) {
                System.out.println("AudioPlayer.<init>(): received target format: " +
                                   audioFormat);
            }
        ...
        if (line == null) {
            System.out.println("AudioPlayer: cannot get SourceDataLine for format " +
                               audioFormat);
            System.exit(1);
        }
