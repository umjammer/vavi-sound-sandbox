...
public class Convert {
    ...
    public static void main(String[] args) {
        if (args.length == 1) {
            ...
            if (targetFileType == null) {
                System.out.println("Unknown target file type. Check with 'Convert -l'.");
                System.exit(1);
            }
    ...
    private static void printUsageAndExit() {
        ...
        System.out.println("\tjava Convert -l");
        System.out.println("\tjava Convert [-t <targettype>]<soundfile>");
        System.exit(0);
    }
